...
import io.heapy.komodo.junit.engine.descriptor.Filterable;
import io.heapy.komodo.junit.engine.descriptor.EnterpriseEngineDescriptor;
import io.heapy.komodo.junit.engine.descriptor.JupiterTestDescriptor;
import io.heapy.komodo.junit.engine.descriptor.MethodBasedTestDescriptor;
import io.heapy.komodo.junit.engine.discovery.predicates.IsInnerClass;
...
class JavaElementsResolver {
	...
	void resolveUniqueId(UniqueIdSelector selector) {
		...
		if (EnterpriseEngineDescriptor.ENGINE_ID.equals(uniqueId.getEngineId().orElse(null))) {
			try {
